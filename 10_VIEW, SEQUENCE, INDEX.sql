...
--TB_TEST UPDATE 시 시퀀스 사용하기

--TB _TEST에서 TEST_NO컬럼갑싱 가장 작은 컬럼 값을 다음 시쿠컨스 번호로 변경
...
--인덱스 사용방법 !  ->웨어절에 인덱스가 지정된 컬럼 언급하기
