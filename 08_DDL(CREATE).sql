...
-- 비밀번호 : MEMBER_PW / 자료형 : VARCHAR(20)
-- 이름     : MEMBER_NAME / 자료형 : VARCHAR(15) (한글 5글자 까지)
...
INSERT INTO "MEMBER"
VALUES('MEMO1', '123ABC', '홍길동', '990515-1234567', TO_DATE('2024-03-06'));
...
CREATE TABLE USER_USED_PK(
    USER_NO NUMBER /* CONSTRAINT USER_NO_PK PRIMARY*/,
...
-->다른테이블이 제공하는 컬럼에는 PK또는 U 제약 조건이 설정되어 있어야 한
...
-->NOT NULL제약조건을 제외한 다른 제약조건은 복사X
